...
/obj/effect/proc_holder/slab/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..() || in_progress)
		return TRUE
...
/obj/effect/proc_holder/slab/hateful_manacles/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/compromise/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/volt/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
...
/obj/effect/proc_holder/slab/kindle/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..())
		return TRUE
	...
	if(target in view(7, get_turf(ranged_ability_user)))
		...
		A.preparePixelProjectile(target, the_one_who_called, params)
		A.fire()
...
/obj/effect/proc_holder/slab/vanguard/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/judicial/InterceptClickOn(mob/living/the_one_who_called, params, atom/target)
	if(..())
		return TRUE
